...
from core.bg_tasks.multi_bg_render_data import lvl1_load_data
...
def lvl1_render(prd_id: int, front_cached: bool):
    # log_debug(Events.bg_product_stage_.format(1) + f' | prd_id = {prd_id}', level='INFO')
    return asyncio.run(lvl1_load_data(prd_id, front_cached))
